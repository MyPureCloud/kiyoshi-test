...
from core.config.creds import TransifexCredsConfiguration
from core.translation_repository import TranslationRepository, TranslationBundle, Translation

import api as transifex
from api import TransifexApiCreds
...
class TransifexRepository(TranslationRepository):
    def __init__(self, config, creds, log_dir):
        ...
        self._transifex_project_slug_prefix = creds.get_project_slug_prefix()
        self._transifex_resource_slug_prefix = creds.get_resource_slug_prefix()
        self._api_creds = TransifexApiCreds(creds.get_username(), creds.get_userpasswd())
