...
class Handler(tornado.web.RequestHandler):
    def get(self, param):
        ...
        self.render('resource.html', resource_config_filename=resource_config_filename, translation_slugs=translation_slugs, resource_slugs=resource_slugs, stats=stats)
